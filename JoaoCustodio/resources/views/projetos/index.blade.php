...
<div class="card-body px-0 pt-0 pb-2">
    <div class="table-responsive p-0">
      <table class="table align-items-center mb-0">
        <thead>
          <tr>
            <th class="text-uppercase text-secondary text-xxs font-weight-bolder opacity-7">Designação</th>
            ...
            <td>
              <div class="d-flex px-2 py-1">
                <div class="d-flex flex-column justify-content-center">
                  ...
                  <p class="text-xs text-secondary mb-0">{{ $projeto->designacao }}</p>
                </div>
              </div>
            </td>
               ...
               {{--  <td class="pull-left">
                    <div>
                        <img src="{{asset("/uploads/fotos/projetos/".$projeto->fotoProjetos->designacao)}}" class="avatar avatar-sm me-1" alt="user1">
                    </div>
                </td> --}}


                <td class="text-center">
                    {{-- <form role="form" method="DELETE" action="/projetos/{{$projeto->id}}" enctype="multipart/form-data">
                        @csrf
                        @method("delete")
                    ...
                    <a href="/projetos/{{ $projeto->id }}/fotos">
                        <button class="btn btn-light" type="submit">
                    ...
                    <a href="/projetos/{{ $projeto->id }}/delete">
                        <button class="btn btn-light" type="submit">
                            <i class="fa fa-trash text-xs font-weight-bold mb-0 text-danger" aria-hidden="true"></i>
                        </button>
                    </a>
        ...
        {{--<td>
          ...
          <tr>--}}
            ...
            {{-- <td>{{ $produto->categoria->designacao }}</td> --}}
