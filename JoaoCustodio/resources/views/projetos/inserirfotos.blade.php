...
<form role="form" method="POST" action="/projetos/inserirFoto" enctype="multipart/form-data">
@csrf
...
<div class="container">
    <div class="row">
        ...
        <div class="col-12 col-md-4">
            <img src="{{asset("/uploads/fotos/projetos/".$foto->designacao)}}" class="img-thumbnail" alt="user1">
            <a href="/projeto/{{$foto->id}}/eliminar" class="btn btn-danger"><i class="fa fa-trash"></i></a>
        </div>
        @endforeach
