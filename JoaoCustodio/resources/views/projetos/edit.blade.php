...
@method("PUT")
    <div class="card-body">
        <div class="form-group">
            ...
            <input type="text" class="form-control" required value="{{ old('inputDesig', $projeto->designacao) }}" name="inputDesig" id="inputDesig" placeholder="Insira a Designação do projeto">
            @error('inputDesig')
                <p class="text-danger">
        ...
        {{-- <div class="form-group">
            ...
            <input type="text" class="form-control" required value="{{ old('preBase') }}" id="preBase" name="preBase" placeholder="Insira o preço base do produto">
            @error('preBase')
            <p class="text-danger">
